const projects = [
  {
    ...
    files: [
      { name: "Soda-Machine Landing.Zip", size: "3.25 MB", link: "#" },
      { name: "Soda-Machine Admin.Zip", size: "3.15 MB", link: "#" },
      { name: "Soda-Machine Logo.Zip", size: "2.02 MB", link: "#" },
  ...
  },
  {
    id: 4,
    img: "img5",
    name: "Soda-Machine Dashboard UI",
